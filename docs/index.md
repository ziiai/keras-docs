...
![Keras](http://cdn.ziiai.com/docs-cover-keras.png)
...
Keras 的核心数据结构是 __model__，一种组织网络层的方式。最简单的模型是 [`Sequential`](/docs/keras/getting-started/sequential-model-guide) 顺序模型，它是由多个网络层线性堆叠的栈。对于更复杂的结构，你应该使用 [Keras 函数式 API](/docs/keras/getting-started/functional-api-guide)，它允许构建任意的神经网络图。
...
- [开始使用 Sequential 顺序模型](/docs/keras/getting-started/sequential-model-guide)
- [开始使用函数式 API](/docs/keras/getting-started/functional-api-guide)
...
- graphviz 和 pydot (用于[可视化工具](/docs/keras/visualization/)绘制模型图)。
...
默认情况下，Keras 将使用 TensorFlow 作为其张量操作库。请[跟随这些指引](/docs/keras/backend/)来配置其他 Keras 后端。
